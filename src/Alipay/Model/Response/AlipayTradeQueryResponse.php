...
class AlipayTradeQueryResponse extends Response
{
    //trade_no 支付宝交易号
    private $tradeNo;
    ...
    public function parse()
    {
        if ($this->response) {
            ...
            if (isset($this->response->send_pay_date)) {
                $this->setSendPayDate($this->response->send_pay_date);
            }
            ...
            if (isset($this->response->trade_status)) {
                $this->setTradeStatus($this->response->trade_status);
            }
            //$this->setFundBillList($this->response->fund_bill_list);
            //$this->setDiscountGoodsDetail($this->response->discount_goods_detail);
        }
        return $this;
    }
